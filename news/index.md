...
- Bug fix:
  ...
  now correctly populates `RMSEcv` and `R2cv` for `rf`, `svmLinear`, and
  `svmRadial` model methods. Previously these were always `NA` for
  non-PLS models.
- Bug fix: Replaced deprecated tidyr and dplyr functions across
  ...
  [`train_spectra()`](https://GoreLab.github.io/waves/reference/train_spectra.md),
  and the `ikeogu.2017` example to resolve deprecation warnings.
- Internal: Fixed `trainControl()` configuration in
  [`train_spectra()`](https://GoreLab.github.io/waves/reference/train_spectra.md)
  — changed `method` from `"repeatedcv"` (with no repeats set) to `"cv"`
...
- Update website
- New vignette:
  [`vignette("waves")`](https://GoreLab.github.io/waves/articles/waves.md)
...
- All functions renamed to match tidystyle. Old functions names work
  ...
  - `FormatCV`-\>
    [`format_cv()`](https://GoreLab.github.io/waves/reference/format_cv.md)
  - [`PlotSpectra()`](https://GoreLab.github.io/waves/reference/rename.md)-\>
    [`plot_spectra()`](https://GoreLab.github.io/waves/reference/plot_spectra.md)
  - [`SaveModel()`](https://GoreLab.github.io/waves/reference/rename.md)-\>
    [`save_model()`](https://GoreLab.github.io/waves/reference/save_model.md)
  - [`TestModelPerformance()`](https://GoreLab.github.io/waves/reference/rename.md)-\>
    [`test_spectra()`](https://GoreLab.github.io/waves/reference/test_spectra.md)
  - [`TrainSpectralModel()`](https://GoreLab.github.io/waves/reference/rename.md)-\>
    [`train_spectra()`](https://GoreLab.github.io/waves/reference/train_spectra.md)
