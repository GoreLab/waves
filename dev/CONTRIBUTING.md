...
This outlines how to propose a change to waves. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("GoreLab/waves", fork = TRUE)`.
...
Please note that the waves project is released with a [Contributor Code
of Conduct](https://GoreLab.github.io/waves/dev/CODE_OF_CONDUCT.md). By
